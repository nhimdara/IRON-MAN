export function EyebrowBadge({ children, className = "" }) {
  return (
    <span
      ...
      style={{
        boxShadow:
          "inset 0 1px 0 rgba(255,255,255,0.06), 0 0 24px -8px rgba(255,181,71,0.25)",
      }}
    >
      <span className="inline-block h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_10px_rgba(255,181,71,0.75)]" />
      {children}
    </span>
  );
}
